...
#
# Arquivo: 02 - Manipulação de Dados.R
#
# Objetivo:
# Realizar consultas e manipulações na base de dados
...
# Objetivo:
# O gerente de Recursos Humanos deseja visualizar toda a base de colaboradores para confirmar se os dados foram carregados corretamente.
...
# Objetivo:
# A diretoria deseja visualizar apenas as colunas Nome, Cargo e Salário.

# Resolução:

funcionarios [c("nome", "cargo", "salario")]
...
# Objetivo:
# Listar todos os colaboradores pertencentes ao departamento de Desenvolvimento.

# Resolução:

funcionarios[funcionarios$departamento == "desenvolvimento", ]
...
# Objetivo:
# Identificar os colaboradores que recebem salário superior a R$ 8.000,00.

# Resolução:

salario_maior <- funcionarios[, "salario"] > 8000

funcionarios[salario_maior, ]
...
# Objetivo:
# Listar todos os colaboradores que trabalham na modalidade remota.

# Resolução:

funcionarios_remoto <- funcionarios [ ,"modalidade"] == "remoto"

funcionarios [funcionarios_remoto, ]
...
# Objetivo:
# Identificar todos os colaboradores que possuem Pós-graduação.

# Resolução:

funcionarios_pos <- funcionarios [ ,"escolaridade"] == "pos graduacao"

funcionarios [funcionarios_pos, ]
...
# Objetivo:
# Identificar os colaboradores com desempenho superior a 9,0.

# Resolução:

funcionarios_9mais <- funcionarios [ ,"desempenho"] >= 9.0

funcionarios [funcionarios_9mais, ]
...
# Objetivo:
# Ordenar os colaboradores do maior para o menor salário.

# Resolução:

funcionarios[order(funcionarios[, "salario"], decreasing = TRUE), ]
...
# Objetivo:
# Calcular a média salarial de todos os colaboradores da empresa.
...
# Objetivo:
# Identificar o maior e o menor salário registrados na base de dados.
